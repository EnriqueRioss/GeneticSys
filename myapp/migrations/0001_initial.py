# Generated by Django 5.1.6 on 2025-06-30 07:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('borrador', 'Borrador'), ('finalizada', 'Finalizada')], default='borrador', max_length=20, verbose_name='Estado de la Historia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('activo', 'Activo'), ('inactivo', 'Inactivo'), ('en_seguimiento', 'En Seguimiento')], default='activo', max_length=20, verbose_name='Estado del Propósito')),
                ('historia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.historiasclinicas')),
            ],
        ),
        migrations.AddField(
